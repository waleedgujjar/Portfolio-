...
const Portfolio = () => {
  ...
  <div className='container portfolio__container'>
    <article className='portfolio__item'>
      ...
      <a href="https://github.com/waleedgujjar/E-Commerce-Website"  className='btn'>GitHub</a>
      <a href="https://e-commerce-website-puce.vercel.app/" className='btn btn-primary'> Live Demo</a>
      </div>
    </article>
    <article className='portfolio__item'>
      <div className='portfolio__item-image'>
    ...
    <article className='portfolio__item'>
      ...
      <h3>Budget App Using React JS</h3>
      <div className="portfolio__item-cta">
      <a href="https://github.com/waleedgujjar/https---github.com-waleedgujjar-Budget-App"  className='btn'>GitHub</a>
      <a href="https://budget-app-lake-eight.vercel.app/" className='btn btn-primary'> Live Demo</a>
      </div>
    </article>
    <article className='portfolio__item'>
      <div className='portfolio__item-image'>
